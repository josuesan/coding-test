...
describe('Low Coverage Product', () => {
  ...
  test('should throw a error if a product is created with the price is less than 80', () => {
    expect(() => factoryProduct.createProduct('Mega Coverage', 0, -80)).toThrow('The product price never is less than 80.')
  });

  test('should throw a error if a product is created with the price is grather than 80', () => {
